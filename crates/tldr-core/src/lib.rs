...
pub use ast::{
    extract_file, extract_file_with_lang, filter_structure_max_depth, get_code_structure,
    get_imports,
};
...
pub use analysis::{
    analyze_definition_order, architecture_analysis, change_impact, change_impact_extended,
    collect_all_functions, dead_code_analysis, enrich_impact_with_references, find_importers,
    find_references, impact_analysis, impact_analysis_with_ast_fallback, names_match,
    ChangeImpactMetadata, ChangeImpactReport, ChangeImpactStatus, DetectionMethod, OrderIssue,
    OrderReport, Reference, ReferenceKind, ReferencesOptions, ReferencesReport, TestFunction,
};
